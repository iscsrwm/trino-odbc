    ...
    switch (info_type) {
        ...
        case SQL_BATCH_SUPPORT:
            *(SQLUINTEGER *)char_attr = 0;
            if (str_len) *str_len = (SQLSMALLINT)sizeof(SQLUINTEGER);
            break;

        case SQL_CATALOG_LOCATION:
            *(SQLUSMALLINT *)char_attr = SQL_CL_START;
            if (str_len) *str_len = (SQLSMALLINT)sizeof(SQLUSMALLINT);
            break;
        ...
        case SQL_CATALOG_TERM:
            ...
            ((char *)char_attr)[buffer_length - 1] = '\0';
            if (str_len) *str_len = (SQLSMALLINT)strlen((char *)char_attr);
            break;

        case SQL_CATALOG_USAGE:
            *(SQLUINTEGER *)char_attr = SQL_CU_DML_STATEMENTS |
